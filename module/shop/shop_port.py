...
PORT_SHOP_SCROLL = Scroll(PORT_SHOP_SCROLL_AREA, color=(156, 182, 239))
PORT_SHOP_SCROLL.color_threshold = 191
PORT_SHOP_SCROLL.edge_threshold = 0.06
PORT_SHOP_SCROLL.drag_threshold = 0.06
